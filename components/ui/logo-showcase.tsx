...
import { CivicSenseSVGLogo, CivicSenseMinimal } from "@/components/ui/svg-logo"
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-blue-50 p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold text-gray-900">CivicSense Logo Variations</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center space-y-2">
                <div className="bg-white p-4 rounded-lg shadow-sm border flex items-center justify-center h-24">
                  <CivicSenseSVGLogo size={64} variant="icon" />
                </div>
              ...
              <div className="text-center space-y-2">
                <div className="bg-white p-4 rounded-lg shadow-sm border flex items-center justify-center h-24">
                  <CivicSenseSVGLogo size={48} variant="full" />
                </div>
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="text-center space-y-2">
                  <div className="bg-white p-4 rounded-lg shadow-sm border flex items-center justify-center h-16">
                    <CivicSenseMinimal size={20} />
                  </div>
                  <p className="text-xs">Size 20px</p>
                </div>
                <div className="text-center space-y-2">
                  <div className="bg-white p-4 rounded-lg shadow-sm border flex items-center justify-center h-16">
                    <CivicSenseMinimal size={24} />
                  </div>
                  <p className="text-xs">Size 24px</p>
                </div>
                <div className="text-center space-y-2">
                  <div className="bg-white p-4 rounded-lg shadow-sm border flex items-center justify-center h-16">
                    <CivicSenseMinimal size={32} />
                  </div>
                  <p className="text-xs">Size 32px</p>
                </div>
                <div className="text-center space-y-2">
                  <div className="bg-white p-4 rounded-lg shadow-sm border flex items-center justify-center h-16">
                    <CivicSenseMinimal size={40} />
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center space-y-2">
                <div className="bg-gray-900 p-6 rounded-lg flex items-center justify-center h-24">
                  <CivicSenseSVGLogo size={48} variant="horizontal" />
                </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Best practices for using the CivicSense logos</CardDescription>
          </CardHeader>
